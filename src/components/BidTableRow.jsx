    ...
    <tr>
      ...
      <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
        ...
        >
          ...
          ></span>
          <h2 className="text-sm font-normal ">{status || "Un Available"}</h2>
        </div>
      </td>
      <td className="px-4 py-4 text-sm whitespace-nowrap">
        ...
        <button
          ...
          className=" disabled:hover:cursor-not-allowed text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none"
        >
          <svg
